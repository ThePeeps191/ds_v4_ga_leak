...
const Space = (() => {
  ...
  // Voxel-style planet: displaced icosahedron + flat shading
  function buildPlanetMesh(config, radius) {
    ...
    for (let i = 0; i < posAttr.count; i++) {
      ...
      const disp = 1 + h * 0.09;
      // Voxel feel: quantized displacement
    ...
    // Cloud layer (orbiting block-cloud sprites)
  ...
  function buildPlanets() {
    const layout = [
      { arch: 0, dist: 0, angle: 0, radius: 500 },        // Starting planet
